    ...
    $.extend(window.aiAssistant, {
        ...
        getWelcomeIntro: function() {
            if (this.isMyWordPressSite()) {
                return 'Hello! I\'m your AI Assistant. I can help you shape My WordPress into a personal software home - create private apps, organize data and memories, manage plugins, and adapt workflows. What would you like to do?';
            }
